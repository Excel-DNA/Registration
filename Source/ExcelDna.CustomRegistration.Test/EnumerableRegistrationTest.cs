...
{
    [TestFixture]
    public class EnumerableRegistrationTest
    {
        //////////////////////////////////////////////////////////////////////////////////////////////
        ...
        {
            typeof (EnumerableRegistrationTest).GetMethod("Reverse").MakeGenericMethod(typeof(TestStructWithCtor)),
            typeof (EnumerableRegistrationTest).GetMethod("Reverse").MakeGenericMethod(typeof(TestClassWithCtor)),
            typeof (EnumerableRegistrationTest).GetMethod("Reverse").MakeGenericMethod(typeof(TestStructDefaultCtor)),
            typeof (EnumerableRegistrationTest).GetMethod("Reverse").MakeGenericMethod(typeof(TestClassDefaultCtor)),
        };
        ...
        public void TestProcessEnumerableRegistrations(MethodInfo methodInfo)
        {
            ...
            var registration = new RegistrationEntry(methodInfo);

            //////////////////////////////////////////
            // act

            IEnumerable<RegistrationEntry> processed = Enumerable.Repeat(registration, 1).ProcessEnumerableRegistrations().ToList();

            //////////////////////////////////////////
            // assert

            Assert.AreEqual(1, processed.Count());
            RegistrationEntry processedRegistration = processed.First();
